...
def generate_weather_data(start_date, end_date, provinces):
    ...
    for date in date_list:
        ...
        for province in provinces:
            # Get base value for this province and month
            ...
            humidity = base_humidity + np.random.uniform(-humidity_variation, humidity_variation)
...
def main():
    ...
    print(f"Created {len(stores)} stores and {len(items)} items across {len(categories)} categories")
    ...
    sales_2016 = generate_sales_data(start_date_2016, end_date_2016, stores, items, weather_dict)
